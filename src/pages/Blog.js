			...
			<ScrollToTop />
				...
				<div className="row px-md-5 py-4">
					<div className=" col-xs-12 col-md-9 col-xl-9 pr-md-5">
						...
						<div className="publish pb-md-5 pb-3" >
							Published on 
						...
						<div className="row px-3 px-md-0 py-md-5 py-3  justify-content-between">
				...
				<div className="col-md-3">
					<div className="row">
						...
						<div className="making-your col-md-12">
						    ...
						    <div className="making-your col-md-12 pt-5">
							...
							<div className="col-md-12 browse aside pt-5 ">
