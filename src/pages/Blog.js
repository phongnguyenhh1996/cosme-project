...
<li className="nav-item2"><a href="#">Multivitamins</a></li>
	...
	<span className="price"><ins><span className="Price-amount">39.00<span className="Price-currencySymbol">
	$</span></span></ins> <del><span className="Price-amount">56.00<span className="Price-currencySymbol">$
	</span></span></del></span>	
